...
bool SignPSBTInput(const SigningProvider& provider, PartiallySignedTransaction& psbt, int index, int sighash = SIGHASH_ALL | SIGHASH_FORKID, SignatureData* out_sigdata = nullptr, bool use_dummy = false);
