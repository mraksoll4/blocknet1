...
static const int FORKID_IN_USE = FORKID_LTFN;
...
//******************************************************************************
//******************************************************************************
LTFNWalletConnector::LTFNWalletConnector() : BtcWalletConnector() {}
...
//******************************************************************************
//******************************************************************************
bool LTFNWalletConnector::createRefundTransaction(const std::vector<XTxIn> & inputs,
                                                 const std::vector<std::pair<std::string, double> > & outputs,
                                                 ...
                                                 std::string & rawTx)
{
    ...
    CScript redeem;
    {
        ...
        {
            LOG() << "ltfn sign transaction error " << __FUNCTION__;
            return false;
        }
    ...
    if (!tx)
    {
        ERR() << "ltfn transaction not created " << __FUNCTION__;
        return false;
    }
    ...
    {
        LOG() << "ltfn decode signed transaction error " << __FUNCTION__;
        return true;
    }
...
//******************************************************************************
//******************************************************************************
bool LTFNWalletConnector::createPaymentTransaction(const std::vector<XTxIn> & inputs,
                                                  const std::vector<std::pair<std::string, double> > & outputs,
                                                  const std::vector<unsigned char> & mpubKey,
                                                  const std::vector<unsigned char> & mprivKey,
